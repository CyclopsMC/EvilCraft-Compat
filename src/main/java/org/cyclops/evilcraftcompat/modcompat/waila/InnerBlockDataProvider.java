...
public class InnerBlockDataProvider implements IWailaDataProvider {
    ...
    public ItemStack getWailaStack(IWailaDataAccessor accessor,
        ...
        if(accessor.getBlock() instanceof ConfigurableBlockWithInnerBlocks && config.getConfig(org.cyclops.evilcraftcompat.modcompat.waila.Waila.getInnerBlockConfigID())) {
