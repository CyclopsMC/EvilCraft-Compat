...
public class BoxOfEternalClosureDataProvider implements IBlockComponentProvider {
    ...
    public static final ResourceLocation ID = new ResourceLocation(Reference.MOD_ID, "box_of_eternal_closure");
        ...
        if (blockAccessor.getBlockEntity() instanceof BlockEntityBoxOfEternalClosure blockEntity) {
            ...
            if (blockEntity.hasSpirit()) {
                ...
                if (spiritData.containsPlayer()) {
                    ...
                    EntityType<?> spiritType = spiritData.isSwarm() ? RegistryEntries.ENTITY_VENGEANCE_SPIRIT : spiritData.getInnerEntityType();
                    if (spiritType != null) {
