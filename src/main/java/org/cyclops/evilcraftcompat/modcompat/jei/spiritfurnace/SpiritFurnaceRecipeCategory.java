...
public class SpiritFurnaceRecipeCategory implements IRecipeCategory<SpiritFurnaceRecipeJEI> {
    ...
    public SpiritFurnaceRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(RegistryEntries.BLOCK_SPIRIT_FURNACE));
    ...
    public Component getTitle() {
        return Component.translatable(RegistryEntries.BLOCK_SPIRIT_FURNACE.getDescriptionId());
    }
